...
{
	std::cout << "entrée Llah Init" << std::endl;
	m_gray.Init(iw,ih,1);
	std::cout << "m_gray.Init OK" << std::endl;
	m_binary.Init(iw,ih,1);
	std::cout << "m_binary.Init OK" << std::endl;
	m_label.Init(iw,ih);
	std::cout << "m_label.Init OK" << std::endl;
	m_bloblist.Init(iw,ih,10);
	std::cout << "m_bloblist.Init OK" << std::endl;
}
